...
void MatrixMultiplication::checkOro( oroError res, const char* file, int line )
{
	if ( res != oroSuccess )
	{
		const char* msg;
...
void MatrixMultiplication::checkOrortc( orortcResult res, const char* file, int line )
{
